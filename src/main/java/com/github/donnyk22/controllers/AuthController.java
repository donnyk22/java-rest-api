...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<MstUsersDto>> register(@RequestBody @Valid UserRegisterForm form,
    ...
    @Operation(summary = "User login", description = "Authenticate user and return credentials.")
    @PostMapping("/login")
    public ResponseEntity<ApiResponse<MstUsersDto>> login(@RequestBody @Valid UserLoginForm form,
            HttpServletRequest httpRequest) {
    ...
    @Operation(summary = "Refresh credentials", description = "Refresh authentication credentials.")
    @PostMapping("/refresh")
