...
@Tag(name = "Message Broker APIs", description = "Message Broker implementation APIs for testing purpose")
...
public class MsBrokerController {
    ...
    @Operation(summary = "Send message to object topic", description = "Send a message to object topic.")
    ...
    @Operation(summary = "Send message to text topic", description = "Send a message to text topic.")
    @PostMapping("/topic/text")
    public ResponseEntity<ApiResponse<String>> sendToTopicText(
            @RequestBody @Valid @NotBlank(message = "message is required") String text) {
