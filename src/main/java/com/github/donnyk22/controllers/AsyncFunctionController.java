...
@Tag(name = "Async Function APIs", description = "Asynchronous function implementation APIs for testing purpose")
...
public class AsyncFunctionController {
    ...
    @Operation(summary = "Send dummy email", description = "Send dummy email and simulate the async process in the background.")
    ...
    @Operation(summary = "Send dummy email with job ID", description = "Send dummy email and simulate the async process in the background with job ID and status")
    ...
    @Operation(summary = "Send dummy email with job ID and Message Broker", description = "Send dummy email and simulate the async process in the background with job ID and handled by Message Broker")
    ...
    @Operation(summary = "Get email status by job ID", description = "Get email queue status by job ID")
    @GetMapping("/status-dummy-email-job-id")
    public ResponseEntity<ApiResponse<AsyncJobResult>> getJobStatus(
            @RequestParam @NotBlank(message = "Job ID is required") String jobId) {
